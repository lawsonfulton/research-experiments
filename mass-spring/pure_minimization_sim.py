...
def main():
    ...
    def potential_energy(q_k, q_k1):
        ...
        sum += mass_matrix @ external_forces @ q_tilde
    ...
    #jac_pre_DEL = autograd.jacobian(pre_DEL, 0)
    ...
    # def objective(new_q, cur_q, prev_q):
    #     A = new_q - 2 * cur_q + prev_q
    ...
    while True:
        ...
        sol = optimize.minimize(pre_DEL, constrained_q, args=(cur_q, prev_q), method='BFGS', options={'disp':False})
        prev_q = cur_q
        cur_q = sol.x
